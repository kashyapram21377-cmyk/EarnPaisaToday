#!/bin/bash
# EarnPaisaToday Full Real Setup + Firebase Integration
...
button { padding:10px 20px; margin:10px; cursor:pointer; background:#ff4500; color:#fff; border:none; border-radius:5px; }
...
// Load offers from offers.json or Firebase
EOL
...
// Handle withdraw requests via Firebase
EOL
...
echo "✅ Done! Visit: https://earnpaisatoday.web.app"
